...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/jayguar1206/Uncursus/blob/new/procursus-deploy-u0.sh)"
echo "Downloading And Installing Offical Procurus Deb"
rm -rf /User/Documents/Uncursus
mkdir /User/Documents/Uncursus
apt update
apt install wget -y --allow-unauthenticated
wget https://github.com/jayguar1206/Uncursus/blob/new/6c8de15b50a580ca170357c6d35211b0a7970b9f/DebProcurusSystem.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
...
wget https://github.com/jayguar1206/Uncursus/blob/new/6c8de15b50a580ca170357c6d35211b0a7970b9f/DebPatch.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
